import torch
from dbond_m_exp_af_rm_attn_cat import Model as Net
...
parser.add_argument(
    ...
    default="./best_model/dbond_m_exp_ei_rm_attn_cat/2025_11_25_19_25_default_0.pt",
)
parser.add_argument(
    "--in_model_comfig_path",
    type=str,
    help="Path to the model config file",
    default="/workspace/dbond_m_exp_ei_config/default.yaml",
)
parser.add_argument(
    "--in_csv_to_predict_path",
    type=str,
    help="Path to the input csv file to predict",
    default="./dataset/dbond_m_exp_ei_rm_attn_cat.test.csv",
)
parser.add_argument(
    "--out_multi_label_pred_dir",
    type=str,
    help="Path to save the multi label prediction result",
    default="./result/pred/dbond_m_exp_ei_rm_attn_cat/multi/",
)
...
parser.add_argument(
    ...
    default="./result/metric/dbond_m_exp_ei_rm_attn_cat/multi/",
)
...
if not os.path.exists(args.out_multi_label_pred_dir):
    os.makedirs(args.out_multi_label_pred_dir)
...
if not os.path.exists(args.out_multi_label_metric_dir):
    os.makedirs(args.out_multi_label_metric_dir)
...
dataset = PepDataset(model_config, split="test")
