import torch
from dbond_m_exp_af_rm_attn import Model as Net
...
parser.add_argument(
    ...
    default="./best_model/dbond_m_exp_ei_rm_attn/2025_11_25_19_25_default_0.pt",
)
parser.add_argument(
...
parser.add_argument(
    ...
    default="./dataset/dbond_m_exp_ei_rm_attn.test.csv",
)
parser.add_argument(
    "--out_multi_label_pred_dir",
    type=str,
    help="Path to save the multi label prediction result",
    default="./result/pred/dbond_m_exp_ei_rm_attn/multi/",
)
...
parser.add_argument(
    ...
    default="./result/metric/dbond_m_exp_ei_rm_attn/multi/",
)
