"""DBond-s-pre+theory 5fold 训练(R-01 pre 变体, 对齐 DBond-GT-pre)。
...
结果输出:
  ./result/cv/dbond_s_pre_theory/{timestamp}/fold_{id}/{best_model,metric,pred,...}/
  ./result/cv/dbond_s_pre_theory/{timestamp}/5fold_metrics.csv  (每 fold 一行)
  ./result/cv/dbond_s_pre_theory/{timestamp}/5fold_summary.csv  (mean ± std)
"""
